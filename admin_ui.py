...
def view_employees():
    print ("")
    print("VECTA CORP HEPL DESK EMPLOYEES")
    print("-" * 95)
    ...
    for employee in employees:
        print(line_format.format(str(employee.employeeid),employee.name, employee.username, employee.password, employee.email, employee.role))
    print("-" * 95)
